...
parser.add_argument("--root_dir", default='/home/newdisk/fty/LZ/MSFC/VOCdevkit/VOC2012', type=str, help="root_dir")
...
parser.add_argument("--cam_path", default='/home/newdisk/fty/LZ/MSFC/work_dir_voc/2024-03-28-12-04-36-083437/logits/train', type=str, help="logit")
parser.add_argument("--dst_dir", default='cam_label_crf2', type=str, help="dst")
parser.add_argument("--bkg_thre_h", default=0.5, type=float, help='bkg_thre')
parser.add_argument("--bkg_thre_l", default=0.25, type=float, help='bkg_thre')
parser.add_argument("--save_label", action="store_true", default=True, help='save crf label')
...
def crf_proc(args):
    ...
    args.dst_dir = args.cam_path.replace("logits", args.dst_dir)
    crf_pred_path = os.path.join(args.dst_dir, 'pred')
    crf_pred_rgb_path = os.path.join(args.dst_dir, 'pred_rgb')
    ...
    print(format_tabs([score], [ "Cam_crf"], cat_list=voc.class_list))
