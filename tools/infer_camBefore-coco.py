...
parser.add_argument("--backbone", default='vit_base_patch16_224', type=str, help="deit_base_patch16_224")
...
parser.add_argument("--base_dir", default="/home/newdisk/fty/LZ/MSFC/results", type=str, help="infer_set")
...
def _validate(model=None, data_loader=None, args=None):
    ...
    return format_tabs([cam_score, cam_aux_score], ["cam", "aux_cam"], cat_list=coco.class_list)
